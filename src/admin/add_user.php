 ...
 <body>
   ...
   <div class="container mx-auto">
    <form class="mx-auto" action="#" method="post">
     ...
     <div class="form-group text-center">
       <input class="form-control-lg text-center" type="password" name="user_pass_two" value="" placeholder="Re-enter Password" required>
     </div>
     <div class="from-group text-center">
  ...
  <?php
    ...
    if(isset($_POST))
    {
      if(StrengthChecker($_POST['user_pass']) && PasswordCheck($_POST['user_pass'],$_POST['user_pass_two']))
      {
        ...
        $add_query  = "INSERT INTO users (USER_ID,USER_FIRST,USER_LAST,USER_RANK,DESCRIPTION,ISADMIN,USER_PASS,IS_INACTIVE)";
        $add_query .= "VALUES('','{$user_first}','{$user_last}','{$user_rank}','{$user_description}','{$admin}','{$user_pass}','{$status}');";
